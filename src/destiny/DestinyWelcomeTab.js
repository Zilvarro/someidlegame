export default function DestinyWelcomeTab({state, popup, updateState}) {
    ...
    const performDestinyReset = ()=>{
        popup.confirm(<>DESTINY RESET<br/><br/>This resets the entire game, including Mails and you won't even be able to access the Destiny Tab again until you make it back here. Making a backup beforehand is highly recommended!<br/><br/>Also there are no new features, this is just a New Game Plus.<br/><br/>PERFORM DESTINY RESET?</>,()=>{
